...
return [
    ...
    | pela classe de validação. Alguns destes regras possuem múltiplas versões
    ...
    */
    ...
    'ascii' => 'O campo :attribute deve conter apenas caracteres ASCII de um byte e símbolos.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nosso placeholder
    | de atributo por algo mais amigável, como "Endereço de E-mail" em vez de "email".
    |
    */
