            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
                ...
                <div class="flex-1 flex justify-center md:justify-start">
                    @if($hasActiveCertificate)
                        {{-- Você precisa adicionar esta imagem na sua pasta /public/images/ --}}
                        <img src="{{ asset('images/certificate-seal.png') }}" alt="Revendedora Certificada"
                             class="w-32 h-auto" title="Esta revendedora é certificada">
                    @endif
                </div>
                    ...
                    <div class="flex-1 flex justify-center md:justify-end">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="relative group">
                                <div class="w-6 h-6 bg-gray-200 text-gray-700 rounded-full flex items-center justify-center text-sm font-bold cursor-pointer">
                                    ⓘ
                                </div>

                                <div class="absolute z-10 left-full top-0 ml-2 w-72
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @endif
                                            <span class="text-sm text-gray-700">{{ $criteriaPercentage }}% de avaliações positivas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
