<x-layout>
    ...
    <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" class="container mx-auto px-4 py-8">
        ...
        <div
            class="mt-8 bg-white m-auto max-w-4xl min-h-70 flex flex-col md:flex-row rounded-2xl border-2 divide-y md:divide-y-0 md:divide-x divide-gray-300 shadow-lg">
